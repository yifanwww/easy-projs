...
const projectRealName = projectName?.includes('@project') ? projectName.slice(9) : projectName;

const project = projectRealName ? path.resolve(paths.projects, projectRealName) : process.cwd();
