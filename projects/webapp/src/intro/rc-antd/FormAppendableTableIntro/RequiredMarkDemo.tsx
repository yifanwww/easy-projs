          ...
          columns={[
            {
              ...
              required: true,
              render: (_, record) => (
                <Form.Item name={[record.name, 'name']} rules={[{ required: true, message: 'Name is required' }]}>
            ...
            },
            {
              ...
              required: true,
              render: (_, record) => (
                <Form.Item name={[record.name, 'email']} rules={[{ required: true, message: 'Email is required' }]}>
